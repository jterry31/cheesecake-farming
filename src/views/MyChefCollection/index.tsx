...
import { Heading, LogoIcon, Text, Button } from 'uikit'
      ...
      <NftProvider>
        <Page>
          <StyledHero>
            ...
            {/*
            <CustomButton onClick={() => history.push(`my-nfts`)} mt="24px">
              My CCAKE NFTs
            </CustomButton>
            
            <CustomButton onClick={() => history.push(`my-nfts-unique`)} mt="24px">
              My Unique NFTs
            </CustomButton>  
            
            <GoldenButton onClick={() => history.push(`my-chef-collection`)} mt="24px">
              My Chef NFTs
            </GoldenButton> 
            */}
