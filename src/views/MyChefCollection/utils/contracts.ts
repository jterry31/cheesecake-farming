...
import chef from 'config/abi/chef.json'
import { NftFarm, NFT, chefNFT } from 'config/constants/chef'
...
export const getChefContract = (contractOptions?: ContractOptions) => {
  const chefAbi = (chef as unknown) as AbiItem
  return getContract(chefAbi, chefNFT, contractOptions)
}
