...
export const mintChef = async (chefContract, price, amount, account) => {
  try {
    return chefContract.methods
      .mint(new BigNumber(price).times(new BigNumber(10).pow(18)).toString(), amount)
      .send({ from: account })
